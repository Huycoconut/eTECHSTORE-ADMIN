...
class DetailProduct extends StatelessWidget {
  DetailProduct({super.key, required this.category, required this.product, required this.sample});
        ...
        child: Obx(
          () => Row(
            ...
            children: [
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            controllerProductSample.changeAtribute();
                          },
                          child: Container(
              ...
              controllerProductSample.showActribute.value
                  ? ManageSample(
                      product: product,
                      sample: sample,
                    )
