...
class SignInScreenMobile extends GetView<SignInController> {
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(
                            () => TextField(
                              focusNode: controller.textFocusNodeEmail,
                              ...
                              onSubmitted: (value) {
                                controller.textFocusNodeEmail.unfocus();
                                FocusScope.of(context).requestFocus(
                                    controller.textFocusNodePassword);
                              },
                              obscureText: controller.hidePassword.value,
                              decoration: InputDecoration(
                                filled: true,
                                errorText: controller.isEditingEmail.value
                          ...
                          const SizedBox(height: 20),
                          const Text(
                              "*Vui lòng đăng nhập tài khoản đã cung cấp",
                              style:
